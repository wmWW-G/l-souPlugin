...
await fs.writeFile(path.join(output, 'build.json'), JSON.stringify({ version: pkg.version, target: target.name, triple: target.triple, builtAt: new Date().toISOString(), runtimeVerified: false }, null, 2));
